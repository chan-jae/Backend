...
public class BookMySqlRepository implements BookJdbcRepository {
    ...
    public UpsertResult bulkInsertBooks(List<BookCreateReq> bookList) {
        ...
        //    INSERT IGNORE 이므로 updated = 0 (기존 행을 수정하지 않음)
        long inserted = Objects.requireNonNullElse(
                jdbcTemplate.queryForObject(COUNT_INSERTED_SQL, Long.class, batchTime), 0L);
